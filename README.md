...
- #### Python
	- [Capstone Project - City of Kelowna: Culture Analysis](https://github.com/vaghulb1992/kelowna_culture_analysis): Implemented machine learning models and visualizations to analyze and discover trends and patterns in survey data obtained by the City of Kelowna (municipal government). 
		- A **Dash dashboard** to analyze the city's cultural makeup can be viewed here: https://kelowna-culture-project.herokuapp.com/.   
		- An **Online Questionnaire** has also been created to collect future responses and to update the findings in the dashboard in real time: https://kelownafeedback.herokuapp.com/
